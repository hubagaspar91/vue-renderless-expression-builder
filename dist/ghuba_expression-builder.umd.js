(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ghuba_expression-builder"] = factory(require("vue"));
	else
		root["ghuba_expression-builder"] = factory(root["Vue"]);
...
// CONCATENATED MODULE: ./src/core/ExpressionNodes.ts
...
var ExpressionNodes_ExpressionNodeBase = /*#__PURE__*/function () {
...
var ExpressionNodes_ExpressionNode = /*#__PURE__*/function (_ExpressionNodeBase) {
  _inherits(ExpressionNode, _ExpressionNodeBase);
  ...
  function ExpressionNode(condition, connectionType, parentNode) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ExpressionNode).call(this, connectionType, parentNode));
  ...
  _createClass(ExpressionNode, [{
    ...
    value: function toJSON() {
      return {
        ...
        condition: _objectSpread2({}, this.condition)
      };
    }
    /**
...
}(ExpressionNodes_ExpressionNodeBase);
...
var ExpressionNodes_ExpressionNodeGroup = /*#__PURE__*/function (_ExpressionNodeBase2) {
  _inherits(ExpressionNodeGroup, _ExpressionNodeBase2);
  ...
  function ExpressionNodeGroup() {
    ...
    _classCallCheck(this, ExpressionNodeGroup);

    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(ExpressionNodeGroup).call(this, connectionType, parentNode));
    opts = _objectSpread2({}, defaultOpts(), {}, opts);
  ...
  _createClass(ExpressionNodeGroup, [{
    key: "toJSON",
    ...
    value: function flatten() {
      ...
      this.children.forEach(function (c) {
        if (c instanceof ExpressionNodes_ExpressionNode) {
            ...
            if (c.connectionType === connectionTypes.AND) {
              ...
              c.flatten().forEach(function (g) {
                if (flattenedList.length > 0) flattenedList.forEach(function (flg) {
                  newFlattenedList.push([].concat(_toConsumableArray(flg), _toConsumableArray(g)));
                });else newFlattenedList.push(g);
              });
              flattenedList = newFlattenedList;
            } else flattenedList = [].concat(_toConsumableArray(flattenedList), _toConsumableArray(c.flatten()));
          }
        } else throw new Error("Node cannot be of type " + _typeof(c));
      });
      if (currentGroup.length > 0) flattenedList.push(currentGroup);
    ...
    value: function fromJSON(json, parentNode) {
      ...
      newGroup.children = json.children.map(function (cJSON) {
        return ExpressionNodeGroup.isJSONInstance(cJSON) ? ExpressionNodeGroup.fromJSON(cJSON, newGroup, currentDepth + 1) : ExpressionNodes_ExpressionNode.fromJSON(cJSON, newGroup);
      });
      return newGroup;
    }
  }]);
...
// CONCATENATED MODULE: ./src/core/ExpressionBuilder.ts
...
var GROUP = "group";
var NODE = "node";
var classes = (_classes = {}, _defineProperty(_classes, GROUP, function (connectionType) {
  return new ExpressionNodes_ExpressionNodeGroup(undefined, connectionType);
}), _defineProperty(_classes, NODE, function (condition, connectionType) {
  return new ExpressionNodes_ExpressionNode(condition, connectionType);
}), _classes);

var ExpressionBuilder_ExpressionBuilder = /*#__PURE__*/function () {
  function ExpressionBuilder(root) {
    _classCallCheck(this, ExpressionBuilder);

    this.root = root ? ExpressionNodes_ExpressionNodeGroup.isJSONInstance(root) ? ExpressionNodes_ExpressionNodeGroup.fromJSON(root) : root : new ExpressionNodes_ExpressionNodeGroup();
  ...
  _createClass(ExpressionBuilder, [{
    ...
    value: function _fluentInsertion(node, operation, index) {
      ...
      if (this._validateIndex(index)) {
        ...
        if (node instanceof ExpressionNodes_ExpressionNodeGroup) {
    ...
    value: function seekContext(path, root) {
      ...
      if (foundNode && foundNode instanceof ExpressionNodes_ExpressionNodeGroup) {
...
//# sourceMappingURL=ghuba_expression-builder.umd.js.map